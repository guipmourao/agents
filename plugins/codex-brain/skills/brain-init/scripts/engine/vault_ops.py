...
from .json_utils import normalize_iso_timestamp
from .ledgers import (
    CLAIM_PATH,
    SOURCE_PATH,
    empty_claim_ledger,
...
def _render_template(content: bytes, generated_at: str) -> bytes:
    normalized = normalize_iso_timestamp(generated_at)
    try:
