...
CHECKPOINT_SCHEMA = "codex-brain.checkpoint.v1"
PENDING_SCHEMA = "codex-brain.checkpoint-pending.v1"
...
def _build_pending(
    ...
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="codex-brain-checkpoint-") as temporary:
