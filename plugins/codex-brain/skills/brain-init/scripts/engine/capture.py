"""Offline-first capture primitives for codex-brain.
...
ADAPTER_SCHEMA = "codex-brain.capture-adapters.v1"
CONFIG_SCHEMA = "codex-brain.capture-config.v1"
QUEUE_SCHEMA = "codex-brain.capture-queue.v1"
ACTION_SCHEMA = "codex-brain.capture-action.v1"
PROPOSAL_SCHEMA = "codex-brain.deletion-proposal.v1"
...
def plan_filesystem_batch(
    ...
    *,
    ...
    for source in checked:
        ...
        plans.append(
            {
                "schema": "codex-brain.filesystem-capture-plan.v1",
                "adapter": "filesystem",
